...
public class Downloader extends UnicastRemoteObject implements DownloaderIndex {
    ...
    public Downloader(String name, String ipA, int portA, String nameA,
        ...
        try {
            ...
            barrels.add(barrel1);
            System.out.println(" Ligado ao barrel : " + nameA + " IP: " + ipA + " PORTA: " + portA);
        } catch (Exception e) {
        ...
        try {
            ...
            barrels.add(barrel2);
            System.out.println(" Ligado ao barrel : " + nameB + " IP: " + ipB + " PORTA: " + portB);
        } catch (Exception e) {
            System.err.println(" Erro ao ligar ao " + nameB + " " + e.getMessage());
        }
